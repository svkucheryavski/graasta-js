...
var app = (function () {
    ...
    function create_if_block$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$d, 20, 3, 381);
    		},
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$d, 15, 3, 307);
    			attr_dev(main, "class", "graasta-app svelte-zlnjf7");
    			add_location(main, file$d, 13, 0, 276);
    		},
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$b, 8, 3, 176);
    			attr_dev(label_1, "for", /*id*/ ctx[0]);
    			attr_dev(label_1, "class", "svelte-1u3qye");
    			add_location(label_1, file$b, 9, 3, 206);
    			...
    			add_location(div1, file$b, 7, 0, 120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class AppControl extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { id: 0, label: 1, disable: 2, hidden: 3 });
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$a, 12, 3, 248);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$7(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$9, 16, 6, 392);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 14, 3, 322);
    			attr_dev(input, "name", /*id*/ ctx[1]);
    			attr_dev(input, "class", "svelte-yqpg3s");
    			add_location(input, file$9, 20, 3, 518);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 337, 21, 12836);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span = element("span");
    			add_location(span, file$8, 338, 48, 12934);
    			attr_dev(div, "class", "axes__ylabel");
    			add_location(div, file$8, 338, 22, 12908);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span = element("span");
    			add_location(span, file$8, 339, 48, 13021);
    			attr_dev(div, "class", "axes__xlabel");
    			add_location(div, file$8, 339, 22, 12995);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_if_block$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$8, 369, 51, 13916);
    			attr_dev(p, "class", "message_error");
    			add_location(p, file$8, 368, 3, 13839);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$6 = "../node_modules/svelte-plots-basic/src/YAxis.svelte";
    ...
    function create_if_block$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "style", /*axisLineStyleStr*/ ctx[7]);
    			add_location(line, file$6, 66, 3, 2703);
    			attr_dev(g, "class", "mdaplot__axis mdaplot__yaxis");
    			add_location(g, file$6, 60, 3, 2240);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    ...
    function create_each_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line0, "style", /*gridLineStyleStr*/ ctx[8]);
    			add_location(line0, file$6, 62, 6, 2314);
    			...
    			attr_dev(line1, "style", /*axisLineStyleStr*/ ctx[7]);
    			add_location(line1, file$6, 63, 6, 2405);
    			...
    			add_location(text_1, file$6, 64, 6, 2507);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, line0, anchor);
    			insert_dev(target, line1, anchor);
    ...
    const file$5 = "../node_modules/svelte-plots-basic/src/Rectangles.svelte";
    ...
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g, file$5, 55, 3, 2004);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$5, 57, 6, 2096);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*sampX, sampY, sampColor, ready*/ 1043) {
    				each_value = /*sampY*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_each_block(ctx) {
    	...
    	scatterseries = new ScatterSeries({
    			props: {
    				...
    				yValues: /*sy*/ ctx[16],
    				borderWidth: 2,
    				borderColor: /*sampColor*/ ctx[10] + (!/*ready*/ ctx[0] || /*i*/ ctx[18] == /*sampY*/ ctx[1].length
    				? "60"
    				: "F0")
    			},
    			$$inline: true
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*sampX*/ 16) scatterseries_changes.xValues = /*sampX*/ ctx[4];
    			if (dirty & /*sampY*/ 2) scatterseries_changes.yValues = /*sy*/ ctx[16];

    			if (dirty & /*ready, sampY*/ 3) scatterseries_changes.borderColor = /*sampColor*/ ctx[10] + (!/*ready*/ ctx[0] || /*i*/ ctx[18] == /*sampY*/ ctx[1].length
    			? "60"
    			: "F0");
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(68:6) {#each sampY as sy, i}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	segments = new Segments({
    			props: {
    				xStart: /*globalX*/ ctx[2],
    				yStart: vsubtract(/*globalY*/ ctx[5], vmult(/*tCrit*/ ctx[8], /*sampE*/ ctx[3])),
    				xEnd: /*globalX*/ ctx[2],
    				yEnd: vadd(/*globalY*/ ctx[5], vmult(/*tCrit*/ ctx[8], /*sampE*/ ctx[3])),
    				lineColor: /*sampColor*/ ctx[10]
    			},
    			$$inline: true
    		});
    	...
    	scatterseries = new ScatterSeries({
    			props: {
    				xValues: /*globalX*/ ctx[2],
    				yValues: /*globalY*/ ctx[5],
    				borderColor: /*sampColor*/ ctx[10],
    				faceColor: /*sampColor*/ ctx[10]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*globalX*/ 4) segments_changes.xStart = /*globalX*/ ctx[2];
    			if (dirty & /*globalY, tCrit, sampE*/ 296) segments_changes.yStart = vsubtract(/*globalY*/ ctx[5], vmult(/*tCrit*/ ctx[8], /*sampE*/ ctx[3]));
    			if (dirty & /*globalX*/ 4) segments_changes.xEnd = /*globalX*/ ctx[2];
    			if (dirty & /*globalY, tCrit, sampE*/ 296) segments_changes.yEnd = vadd(/*globalY*/ ctx[5], vmult(/*tCrit*/ ctx[8], /*sampE*/ ctx[3]));
    			segments.$set(segments_changes);
    			const scatterseries_changes = {};
    			if (dirty & /*globalX*/ 4) scatterseries_changes.xValues = /*globalX*/ ctx[2];
    			if (dirty & /*globalY*/ 32) scatterseries_changes.yValues = /*globalY*/ ctx[5];
    			scatterseries.$set(scatterseries_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(73:3) {#if ready && sampE.length > 0 }",
    		ctx
    	});
    ...
    // (62:0) <Axes limX={[0, 6]} limY={mrange(popY, 0.35)} yLabel="Coefficient">
    function create_default_slot$2(ctx) {
    	...
    	let if_block1 = /*ready*/ ctx[0] && /*sampE*/ ctx[3].length > 0 && create_if_block$1(ctx);

    	const block = {
    		c: function create() {
    			create_component(barseries0.$$.fragment);
    			t0 = space();
    			create_component(barseries1.$$.fragment);
    			t1 = space();
    			if (if_block0) if_block0.c();
    			t2 = space();
    			if (if_block1) if_block1.c();
    		...
    		m: function mount(target, anchor) {
    			mount_component(barseries0, target, anchor);
    			insert_dev(target, t0, anchor);
    			mount_component(barseries1, target, anchor);
    		...
    		p: function update(ctx, dirty) {
    			const barseries0_changes = {};
    			if (dirty & /*popX*/ 128) barseries0_changes.xValues = /*popX*/ ctx[7];
    			if (dirty & /*popY*/ 64) barseries0_changes.yValues = /*popY*/ ctx[6];
    			barseries0.$set(barseries0_changes);
    			const barseries1_changes = {};
    			if (dirty & /*globalX*/ 4) barseries1_changes.xValues = /*globalX*/ ctx[2];
    			if (dirty & /*globalY*/ 32) barseries1_changes.yValues = /*globalY*/ ctx[5];
    			barseries1.$set(barseries1_changes);
    			...
    			if (/*ready*/ ctx[0] && /*sampE*/ ctx[3].length > 0) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);

    					if (dirty & /*ready, sampE*/ 9) {
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(barseries0.$$.fragment, local);
    			transition_in(barseries1.$$.fragment, local);
    			transition_in(if_block0);
    			transition_in(if_block1);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(barseries0.$$.fragment, local);
    			transition_out(barseries1.$$.fragment, local);
    			transition_out(if_block0);
    			transition_out(if_block1);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(barseries0, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(barseries1, detaching);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(62:0) <Axes limX={[0, 6]} limY={mrange(popY, 0.35)} yLabel=\\\"Coefficient\\\">",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			const axes_changes = {};
    			if (dirty & /*popY*/ 64) axes_changes.limY = mrange$1(/*popY*/ ctx[6], 0.35);

    			if (dirty & /*$$scope, globalX, globalY, tCrit, sampE, ready, sampY, sampX, popX, popY*/ 524799) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['popModel', 'globalModel', 'localModel', 'reset', 'ready'];
    	...
    	$$self.$$set = $$props => {
    		if ('popModel' in $$props) $$invalidate(11, popModel = $$props.popModel);
    		if ('globalModel' in $$props) $$invalidate(12, globalModel = $$props.globalModel);
    		if ('localModel' in $$props) $$invalidate(13, localModel = $$props.localModel);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('sampE' in $$props) $$invalidate(3, sampE = $$props.sampE);
    		if ('globalX' in $$props) $$invalidate(2, globalX = $$props.globalX);
    		if ('sampX' in $$props) $$invalidate(4, sampX = $$props.sampX);
    		if ('globalY' in $$props) $$invalidate(5, globalY = $$props.globalY);
    		if ('popY' in $$props) $$invalidate(6, popY = $$props.popY);
    		if ('popX' in $$props) $$invalidate(7, popX = $$props.popX);
    		if ('tCrit' in $$props) $$invalidate(8, tCrit = $$props.tCrit);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*globalModel*/ 4096) {
    			// t-value for confidence interval
    			$$invalidate(8, tCrit = qt(0.975, globalModel.data.X[0].length - 1));
    		}

    		if ($$self.$$.dirty & /*popModel*/ 2048) {
    			// coefficients for populaiton model
    			$$invalidate(7, popX = seq(1, popModel.coeffs.estimate.length).map(x => x - 0.25));
    		}

    		if ($$self.$$.dirty & /*popModel*/ 2048) {
    			$$invalidate(6, popY = popModel.coeffs.estimate);
    		}

    		if ($$self.$$.dirty & /*globalModel*/ 4096) {
    			// coefficients for global model
    			$$invalidate(2, globalX = seq(1, globalModel.coeffs.estimate.length).map(x => x + 0.25));
    		}

    		if ($$self.$$.dirty & /*globalModel*/ 4096) {
    			$$invalidate(5, globalY = globalModel.coeffs.estimate);
    		}

    		if ($$self.$$.dirty & /*reset, localModel*/ 24576) {
    		...
    		if ($$self.$$.dirty & /*globalX*/ 4) {
    			// coefficients and errors for local model
    			$$invalidate(4, sampX = globalX);
    		}

    		if ($$self.$$.dirty & /*localModel, sampY*/ 8194) {
    			$$invalidate(1, sampY = localModel ? [...sampY, localModel.coeffs.estimate] : []);
    		}

    		if ($$self.$$.dirty & /*ready*/ 1) {
    			// if ready - compute error bars
    			if (ready) {
    				$$invalidate(3, sampE = getJKVar());
    			}
    		}
    	};
    ...
    class AppCoeffsPlot extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*popModel*/ ctx[11] === undefined && !('popModel' in props)) {
    			console.warn("<AppCoeffsPlot> was created without expected prop 'popModel'");
    		}

    		if (/*globalModel*/ ctx[12] === undefined && !('globalModel' in props)) {
    			console.warn("<AppCoeffsPlot> was created without expected prop 'globalModel'");
    		}

    		if (/*localModel*/ ctx[13] === undefined && !('localModel' in props)) {
    			console.warn("<AppCoeffsPlot> was created without expected prop 'localModel'");
    		}
    ...
    // (78:3) {#if localModel !== undefined && indSeg >= 0}
    function create_if_block(ctx) {
    	...
    	scatterseries0 = new ScatterSeries({
    			props: {
    				xValues: /*xLocalVal*/ ctx[7],
    				yValues: /*yLocalVal*/ ctx[8],
    				borderWidth: 2,
    				markerSize: 1.2,
    				faceColor: /*colorLocalValLight*/ ctx[18]
    			},
    			$$inline: true
    		});
    	...
    	scatterseries1 = new ScatterSeries({
    			props: {
    				...
    				borderWidth: 2,
    				markerSize: 1.2,
    				borderColor: /*colorLocalVal*/ ctx[17]
    			},
    			$$inline: true
    		});
    	...
    	lineseries = new LineSeries({
    			props: {
    				xValues: /*lineX*/ ctx[4],
    				yValues: /*lineYLocal*/ ctx[10],
    				lineColor: /*colorLocalVal*/ ctx[17]
    			},
    			$$inline: true
    		});
    	...
    	textlegend = new TextLegend({
    			props: {
    				textSize: 1.05,
    				left: min$1(/*xPop*/ ctx[6]) * 0.55 + max$1(/*xPop*/ ctx[6]) * 0.45,
    				top: min$1(/*yPop*/ ctx[15]) * 0.9 + max$1(/*yPop*/ ctx[15]) * 0.1,
    				dx: "1em",
    				dy: "1.35em",
    				elements: /*textLocal*/ ctx[9]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*xLocalVal*/ 128) scatterseries0_changes.xValues = /*xLocalVal*/ ctx[7];
    			if (dirty & /*yLocalVal*/ 256) scatterseries0_changes.yValues = /*yLocalVal*/ ctx[8];
    			scatterseries0.$set(scatterseries0_changes);
    			const scatterseries1_changes = {};
    			if (dirty & /*xLocalVal*/ 128) scatterseries1_changes.xValues = /*xLocalVal*/ ctx[7];
    			if (dirty & /*yLocalVal*/ 256) scatterseries1_changes.yValues = /*yLocalVal*/ ctx[8];
    			scatterseries1.$set(scatterseries1_changes);
    			const lineseries_changes = {};
    			if (dirty & /*lineX*/ 16) lineseries_changes.xValues = /*lineX*/ ctx[4];
    			if (dirty & /*lineYLocal*/ 1024) lineseries_changes.yValues = /*lineYLocal*/ ctx[10];
    			lineseries.$set(lineseries_changes);
    			const textlegend_changes = {};
    			if (dirty & /*xPop*/ 64) textlegend_changes.left = min$1(/*xPop*/ ctx[6]) * 0.55 + max$1(/*xPop*/ ctx[6]) * 0.45;
    			if (dirty & /*yPop*/ 32768) textlegend_changes.top = min$1(/*yPop*/ ctx[15]) * 0.9 + max$1(/*yPop*/ ctx[15]) * 0.1;
    			if (dirty & /*textLocal*/ 512) textlegend_changes.elements = /*textLocal*/ ctx[9];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(78:3) {#if localModel !== undefined && indSeg >= 0}",
    		ctx
    	});
    ...
    // (65:0) <Axes limX={mrange(xPop)} limY={mrange(yPop)} xLabel="x" yLabel="y">
    function create_default_slot$1(ctx) {
    	...
    	lineseries0 = new LineSeries({
    			props: {
    				xValues: /*lineXPop*/ ctx[5],
    				yValues: /*lineYPop*/ ctx[13],
    				lineColor: "#c0c0c0",
    				lineType: 3
    			},
    			$$inline: true
    	...
    	textlegend0 = new TextLegend({
    			props: {
    				textSize: 1.05,
    				left: min$1(/*xPop*/ ctx[6]),
    				top: max$1(/*yPop*/ ctx[15]),
    				dx: "1em",
    				dy: "1.35em",
    				elements: /*textPop*/ ctx[14]
    			},
    			$$inline: true
    		});
    	...
    	scatterseries1 = new ScatterSeries({
    			props: {
    				xValues: /*xGlobal*/ ctx[3],
    				yValues: /*yGlobal*/ ctx[2],
    				borderWidth: 1,
    				faceColor: /*colorGlobal*/ ctx[16],
    				borderColor: /*colorGlobal*/ ctx[16]
    			},
    			$$inline: true
    		});
    	...
    	lineseries1 = new LineSeries({
    			props: {
    				xValues: /*lineX*/ ctx[4],
    				yValues: /*lineYGlobal*/ ctx[11],
    				lineColor: /*colorGlobal*/ ctx[16]
    			},
    			$$inline: true
    		});
    	...
    	textlegend1 = new TextLegend({
    			props: {
    				textSize: 1.05,
    				left: min$1(/*xPop*/ ctx[6]),
    				top: max$1(/*yPop*/ ctx[15]) - 2,
    				dx: "1em",
    				dy: "1.35em",
    				elements: /*textGlobal*/ ctx[12]
    			},
    			$$inline: true
    		});

    	let if_block = /*localModel*/ ctx[0] !== undefined && /*indSeg*/ ctx[1] >= 0 && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const scatterseries0_changes = {};
    			if (dirty & /*xPop*/ 64) scatterseries0_changes.xValues = /*xPop*/ ctx[6];
    			if (dirty & /*yPop*/ 32768) scatterseries0_changes.yValues = /*yPop*/ ctx[15];
    			scatterseries0.$set(scatterseries0_changes);
    			const lineseries0_changes = {};
    			if (dirty & /*lineXPop*/ 32) lineseries0_changes.xValues = /*lineXPop*/ ctx[5];
    			if (dirty & /*lineYPop*/ 8192) lineseries0_changes.yValues = /*lineYPop*/ ctx[13];
    			lineseries0.$set(lineseries0_changes);
    			const textlegend0_changes = {};
    			if (dirty & /*xPop*/ 64) textlegend0_changes.left = min$1(/*xPop*/ ctx[6]);
    			if (dirty & /*yPop*/ 32768) textlegend0_changes.top = max$1(/*yPop*/ ctx[15]);
    			if (dirty & /*textPop*/ 16384) textlegend0_changes.elements = /*textPop*/ ctx[14];
    			textlegend0.$set(textlegend0_changes);
    			const scatterseries1_changes = {};
    			if (dirty & /*xGlobal*/ 8) scatterseries1_changes.xValues = /*xGlobal*/ ctx[3];
    			if (dirty & /*yGlobal*/ 4) scatterseries1_changes.yValues = /*yGlobal*/ ctx[2];
    			scatterseries1.$set(scatterseries1_changes);
    			const lineseries1_changes = {};
    			if (dirty & /*lineX*/ 16) lineseries1_changes.xValues = /*lineX*/ ctx[4];
    			if (dirty & /*lineYGlobal*/ 2048) lineseries1_changes.yValues = /*lineYGlobal*/ ctx[11];
    			lineseries1.$set(lineseries1_changes);
    			const textlegend1_changes = {};
    			if (dirty & /*xPop*/ 64) textlegend1_changes.left = min$1(/*xPop*/ ctx[6]);
    			if (dirty & /*yPop*/ 32768) textlegend1_changes.top = max$1(/*yPop*/ ctx[15]) - 2;
    			if (dirty & /*textGlobal*/ 4096) textlegend1_changes.elements = /*textGlobal*/ ctx[12];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(65:0) <Axes limX={mrange(xPop)} limY={mrange(yPop)} xLabel=\\\"x\\\" yLabel=\\\"y\\\">",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	axes = new Axes({
    			props: {
    				limX: mrange$1(/*xPop*/ ctx[6]),
    				limY: mrange$1(/*yPop*/ ctx[15]),
    				xLabel: "x",
    				yLabel: "y",
    				$$slots: {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			const axes_changes = {};
    			if (dirty & /*xPop*/ 64) axes_changes.limX = mrange$1(/*xPop*/ ctx[6]);
    			if (dirty & /*yPop*/ 32768) axes_changes.limY = mrange$1(/*yPop*/ ctx[15]);

    			if (dirty & /*$$scope, xPop, yPop, textLocal, lineX, lineYLocal, xLocalVal, yLocalVal, localModel, indSeg, textGlobal, lineYGlobal, xGlobal, yGlobal, textPop, lineXPop, lineYPop*/ 8454143) {
    				axes_changes.$$scope = { dirty, ctx };
    			}
    ...
    function getModelString(m, name, color) {
    	...
    	return [
    		...
    		'y =  ' + m.coeffs.estimate.map((b, p) => (p > 0 ? '+' : '') + ' <tspan fill="' + color + '" font-weight=bold>' + b.toFixed(2) + '</tspan>' + (p > 0
    		? '<tspan dx="0.05em" font-weight=bold>x</tspan>'
    		: '') + (p > 1
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let textLocal = [];
    	let lineYLocal = [];
    	const writable_props = ['popModel', 'globalModel', 'localModel', 'indSeg'];
    	...
    	$$self.$$set = $$props => {
    		if ('popModel' in $$props) $$invalidate(19, popModel = $$props.popModel);
    		if ('globalModel' in $$props) $$invalidate(20, globalModel = $$props.globalModel);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('localModel' in $$props) $$invalidate(0, localModel = $$props.localModel);
    		if ('indSeg' in $$props) $$invalidate(1, indSeg = $$props.indSeg);
    		if ('xLocal' in $$props) xLocal = $$props.xLocal;
    		if ('yLocal' in $$props) yLocal = $$props.yLocal;
    		if ('xLocalVal' in $$props) $$invalidate(7, xLocalVal = $$props.xLocalVal);
    		if ('yLocalVal' in $$props) $$invalidate(8, yLocalVal = $$props.yLocalVal);
    		if ('textLocal' in $$props) $$invalidate(9, textLocal = $$props.textLocal);
    		if ('lineYLocal' in $$props) $$invalidate(10, lineYLocal = $$props.lineYLocal);
    		if ('yGlobal' in $$props) $$invalidate(2, yGlobal = $$props.yGlobal);
    		if ('xGlobal' in $$props) $$invalidate(3, xGlobal = $$props.xGlobal);
    		if ('lineX' in $$props) $$invalidate(4, lineX = $$props.lineX);
    		if ('lineYGlobal' in $$props) $$invalidate(11, lineYGlobal = $$props.lineYGlobal);
    		if ('textGlobal' in $$props) $$invalidate(12, textGlobal = $$props.textGlobal);
    		if ('lineXPop' in $$props) $$invalidate(5, lineXPop = $$props.lineXPop);
    		if ('lineYPop' in $$props) $$invalidate(13, lineYPop = $$props.lineYPop);
    		if ('textPop' in $$props) $$invalidate(14, textPop = $$props.textPop);
    		if ('xPop' in $$props) $$invalidate(6, xPop = $$props.xPop);
    		if ('yPop' in $$props) $$invalidate(15, yPop = $$props.yPop);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*popModel*/ 524288) {
    			// points and statistics for population model
    			$$invalidate(6, xPop = popModel.data.X[0]);
    		}

    		if ($$self.$$.dirty & /*popModel*/ 524288) {
    			$$invalidate(15, yPop = popModel.data.y);
    		}

    		if ($$self.$$.dirty & /*xPop*/ 64) {
    			$$invalidate(5, lineXPop = seq(min$1(xPop), max$1(xPop), 100));
    		}

    		if ($$self.$$.dirty & /*popModel*/ 524288) {
    			$$invalidate(14, textPop = getModelString(popModel, "Population model", "#909090"));
    		}

    		if ($$self.$$.dirty & /*popModel, lineXPop*/ 524320) {
    			$$invalidate(13, lineYPop = polypredict(popModel, lineXPop));
    		}

    		if ($$self.$$.dirty & /*globalModel*/ 1048576) {
    			// points and statistics for global model
    			$$invalidate(3, xGlobal = globalModel.data.X[0]);
    		}

    		if ($$self.$$.dirty & /*globalModel*/ 1048576) {
    			$$invalidate(2, yGlobal = globalModel.data.y);
    		}

    		if ($$self.$$.dirty & /*xGlobal*/ 8) {
    			$$invalidate(4, lineX = seq(min$1(xGlobal), max$1(xGlobal), 100));
    		}

    		if ($$self.$$.dirty & /*globalModel*/ 1048576) {
    			$$invalidate(12, textGlobal = getModelString(globalModel, "Global model", colorLocalVal + "b0"));
    		}

    		if ($$self.$$.dirty & /*globalModel, lineX*/ 1048592) {
    			$$invalidate(11, lineYGlobal = polypredict(globalModel, lineX));
    		}

    		if ($$self.$$.dirty & /*localModel, indSeg, lineX, xGlobal, yGlobal*/ 31) {
    			// points and statistics for current local model
    			if (localModel !== undefined) {
    				xLocal = localModel.data.X[0];
    				yLocal = localModel.data.y;

    				$$invalidate(9, textLocal = indSeg >= 0
    				? getModelString(localModel, "Local model", colorLocalVal)
    				: "");

    				$$invalidate(10, lineYLocal = polypredict(localModel, lineX));
    				$$invalidate(7, xLocalVal = [xGlobal[indSeg]]);
    				$$invalidate(8, yLocalVal = [yGlobal[indSeg]]);
    			}
    		}
    	};
    ...
    class AppPlot extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*popModel*/ ctx[19] === undefined && !('popModel' in props)) {
    			console.warn("<AppPlot> was created without expected prop 'popModel'");
    		}

    		if (/*globalModel*/ ctx[20] === undefined && !('globalModel' in props)) {
    ...
    // (125:9) <AppControlArea>
    function create_default_slot_1(ctx) {
    	let appcontrolswitch;
    	let updating_value;
    	let t0;
    	let appcontrolbutton0;
    	let t1;
    	let appcontrolbutton1;
    	let current;
    	...
    	let appcontrolswitch_props = {
    		disable: /*indSeg*/ ctx[3] > -1,
    		id: "pDegree",
    		label: "Polynomial",
    		options: Object.keys(/*pDegrees*/ ctx[7])
    	};

    	if (/*pName*/ ctx[0] !== void 0) {
    		appcontrolswitch_props.value = /*pName*/ ctx[0];
    	}
    	...
    	appcontrolbutton0 = new AppControlButton({
    			props: {
    				disable: /*indSeg*/ ctx[3] > -1,
    				id: "runCV",
    				label: "Sample",
    	...
    	appcontrolbutton0.$on("click", /*click_handler*/ ctx[14]);

    	appcontrolbutton1 = new AppControlButton({
    			props: {
    				disable: /*indSeg*/ ctx[3] > -1,
    				id: "runCV",
    				label: "CV",
    	...
    	appcontrolbutton1.$on("click", /*click_handler_1*/ ctx[15]);

    	const block = {
    		c: function create() {
    			create_component(appcontrolswitch.$$.fragment);
    			t0 = space();
    			create_component(appcontrolbutton0.$$.fragment);
    			t1 = space();
    			create_component(appcontrolbutton1.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(appcontrolswitch, target, anchor);
    			insert_dev(target, t0, anchor);
    			mount_component(appcontrolbutton0, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(appcontrolbutton1, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const appcontrolswitch_changes = {};
    			if (dirty & /*indSeg*/ 8) appcontrolswitch_changes.disable = /*indSeg*/ ctx[3] > -1;

    			if (!updating_value && dirty & /*pName*/ 1) {
    				updating_value = true;
    				appcontrolswitch_changes.value = /*pName*/ ctx[0];
    				add_flush_callback(() => updating_value = false);
    			}

    			appcontrolswitch.$set(appcontrolswitch_changes);
    			const appcontrolbutton0_changes = {};
    			if (dirty & /*indSeg*/ 8) appcontrolbutton0_changes.disable = /*indSeg*/ ctx[3] > -1;
    			appcontrolbutton0.$set(appcontrolbutton0_changes);
    			const appcontrolbutton1_changes = {};
    			if (dirty & /*indSeg*/ 8) appcontrolbutton1_changes.disable = /*indSeg*/ ctx[3] > -1;
    			appcontrolbutton1.$set(appcontrolbutton1_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(appcontrolswitch.$$.fragment, local);
    			transition_in(appcontrolbutton0.$$.fragment, local);
    			transition_in(appcontrolbutton1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(appcontrolswitch.$$.fragment, local);
    			transition_out(appcontrolbutton0.$$.fragment, local);
    			transition_out(appcontrolbutton1.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(appcontrolswitch, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(appcontrolbutton0, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(appcontrolbutton1, detaching);
    		}
    	};
    ...
    function create_default_slot(ctx) {
    	...
    	appplot = new AppPlot({
    			props: {
    				indSeg: /*indSeg*/ ctx[3],
    				localModel: /*localModel*/ ctx[4],
    				globalModel: /*globalModel*/ ctx[6],
    				popModel: /*popModel*/ ctx[5]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*localModel*/ 16) appplot_changes.localModel = /*localModel*/ ctx[4];
    			if (dirty & /*globalModel*/ 64) appplot_changes.globalModel = /*globalModel*/ ctx[6];
    			if (dirty & /*popModel*/ 32) appplot_changes.popModel = /*popModel*/ ctx[5];
    			appplot.$set(appplot_changes);
    			const appcoeffsplot_changes = {};
    			if (dirty & /*localModel*/ 16) appcoeffsplot_changes.localModel = /*localModel*/ ctx[4];
    			if (dirty & /*globalModel*/ 64) appcoeffsplot_changes.globalModel = /*globalModel*/ ctx[6];
    			if (dirty & /*popModel*/ 32) appcoeffsplot_changes.popModel = /*popModel*/ ctx[5];
    			if (dirty & /*reset*/ 2) appcoeffsplot_changes.reset = /*reset*/ ctx[1];
    			if (dirty & /*ready*/ 4) appcoeffsplot_changes.ready = /*ready*/ ctx[2];
    			appcoeffsplot.$set(appcoeffsplot_changes);
    			const appcontrolarea_changes = {};

    			if (dirty & /*$$scope, indSeg, pName*/ 16777225) {
    ...
    function create_help_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h2 = element("h2");
    			h2.textContent = "Jackknife resampling for regression coefficients";
    			t1 = space();
    			p0 = element("p");
    			t2 = text("Jackknife resampling is a way to make an inference (e.g. compute confidence intervals of find a p-value for H0: β = 0) for regression coefficients based on full cross-validation. The idea is to estimate a variance of regression coefficients computed for each local model (every time we take one sample out, we compute a new model, which is called ");
    			em0 = element("em");
    			em0.textContent = "local";
    			t4 = text(") and then compute\n         the standard error for the coefficient based on this variance.");
    			t5 = space();
    			p1 = element("p");
    			t6 = text("In this app population consists of 500 measurements of ");
    			em1 = element("em");
    			em1.textContent = "x";
    			t8 = text(" and ");
    			em2 = element("em");
    			...
    			em3 = element("em");
    			em3.textContent = "y";
    			t12 = text(" linearly depends on ");
    			em4 = element("em");
    			em4.textContent = "x";
    			t14 = text(". However, if you take a small sample (in this app the sample size is fixed to ");
    			em5 = element("em");
    			em5.textContent = "n";
    			t16 = text(" = 12), it can have a random non-linear effect in the ");
    			em6 = element("em");
    			em6.textContent = "y";
    			t18 = text("(");
    			em7 = element("em");
    			em7.textContent = "x";
    			t20 = text(") relationship, so when this sample is fitted by a polynomial model, the regression coefficients for quadratic or cubic terms will not be zero. But if you use Jackknife, then most of the time it will be able to detect that the estimated coefficients are in fact not significant, so statistically they are not distinguishable from zero.");
    			t21 = space();
    			p2 = element("p");
    			t22 = text("In order to investigate this, set polynomial to ");
    			em8 = element("em");
    			em8.textContent = "cubic";
    			t24 = text(" and take a sample where the last two regression coefficients will be\n         relatively large, so you can see them as small blue bars on the coefficients' plot. Then run the cross-validation procedure and see how all coefficients vary for the local models. At the end you will see errorbars which correspond to 95% confidence intervals and for the non-linear terms, most of the time, the interval will cross zero.");
    			add_location(h2, file, 145, 6, 4106);
    			add_location(em0, file, 147, 356, 4530);
    			add_location(p0, file, 146, 6, 4170);
    			add_location(em1, file, 151, 64, 4720);
    			add_location(em2, file, 151, 79, 4735);
    			add_location(em3, file, 151, 97, 4753);
    			add_location(em4, file, 151, 128, 4784);
    			add_location(em5, file, 151, 217, 4873);
    			add_location(em6, file, 151, 281, 4937);
    			add_location(em7, file, 151, 292, 4948);
    			add_location(p1, file, 150, 6, 4652);
    			add_location(em8, file, 154, 57, 5372);
    			add_location(p2, file, 153, 6, 5311);
    			attr_dev(div, "slot", "help");
    			add_location(div, file, 144, 3, 4082);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, indSeg, pName, localModel, globalModel, popModel, reset, ready*/ 16777343) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function takeNewSample() {
    		...
    		$$invalidate(10, sampX = subset(popX, sampInd));
    		$$invalidate(11, sampY = subset(popY, sampInd));
    	}
    	...
    	function resetAll() {
    		...
    		$$invalidate(4, localModel = undefined);
    	...
    	async function run() {
    		...
    		for ($$invalidate(3, indSeg = 0); indSeg < sampSize; $$invalidate(3, indSeg++, indSeg)) {
    			const calInd = ind.filter(v => v != indSeg + 1);
    			$$invalidate(4, localModel = polyfit(subset(sampX, calInd), subset(sampY, calInd), pDegree));
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('yCV' in $$props) yCV = $$props.yCV;
    		if ('localModel' in $$props) $$invalidate(4, localModel = $$props.localModel);
    		if ('sampInd' in $$props) sampInd = $$props.sampInd;
    		if ('sampX' in $$props) $$invalidate(10, sampX = $$props.sampX);
    		if ('sampY' in $$props) $$invalidate(11, sampY = $$props.sampY);
    		if ('pDegree' in $$props) $$invalidate(12, pDegree = $$props.pDegree);
    		if ('popModel' in $$props) $$invalidate(5, popModel = $$props.popModel);
    		if ('globalModel' in $$props) $$invalidate(6, globalModel = $$props.globalModel);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*pName*/ 1) {
    			// change polynomial degree
    			$$invalidate(12, pDegree = getPDegree(pName));
    		}

    		if ($$self.$$.dirty & /*sampX, sampY, pDegree*/ 7168) {
    			// create global model for given polynomial degree
    			$$invalidate(6, globalModel = polyfit(sampX, sampY, pDegree));
    		}

    		if ($$self.$$.dirty & /*pDegree*/ 4096) {
    			// create population model for given polynomial degree
    			$$invalidate(5, popModel = polyfit(popX, popY, pDegree));
    		}
    	};
