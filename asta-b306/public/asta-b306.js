...
var app = (function () {
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$b, 12, 3, 248);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "table-container svelte-sj44zy");
    ...
    function create_else_block(ctx) {
    	...
    	scatterseries = new ScatterSeries({
    			props: {
    				...
    				borderWidth: 1,
    				faceColor: /*colorGlobal*/ ctx[12],
    				borderColor: /*colorGlobal*/ ctx[12]
    			},
    			$$inline: true
    		});
    	...
    	lineseries = new LineSeries({
    			props: {
    				xValues: /*lineX*/ ctx[5],
    				yValues: /*lineYGlobal*/ ctx[10],
    				lineColor: /*colorGlobal*/ ctx[12]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*lineYGlobal*/ 1024) lineseries_changes.yValues = /*lineYGlobal*/ ctx[10];
    ...
    // (73:3) {#if localModel !== undefined && indSeg >= 0}
    function create_if_block_1(ctx) {
    	...
    	scatterseries0 = new ScatterSeries({
    			props: {
    				...
    				yValues: /*yGlobal*/ ctx[3],
    				borderWidth: 1,
    				faceColor: /*colorLocal*/ ctx[13],
    				borderColor: /*colorLocal*/ ctx[13]
    			},
    			$$inline: true
    		});
    	...
    	scatterseries1 = new ScatterSeries({
    			props: {
    				xValues: /*xLocalVal*/ ctx[6],
    				yValues: /*yLocalVal*/ ctx[7],
    				borderWidth: 2,
    				markerSize: 1.2,
    				borderColor: /*colorLocalVal*/ ctx[14]
    			},
    			$$inline: true
    		});
    	...
    	lineseries1 = new LineSeries({
    			props: {
    				xValues: /*lineX*/ ctx[5],
    				yValues: /*lineYLocal*/ ctx[9],
    				lineColor: /*colorLocalVal*/ ctx[14]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*lineX*/ 32) lineseries0_changes.xValues = /*lineX*/ ctx[5];
    			if (dirty & /*lineYGlobal*/ 1024) lineseries0_changes.yValues = /*lineYGlobal*/ ctx[10];
    			lineseries0.$set(lineseries0_changes);
    			const scatterseries0_changes = {};
    			if (dirty & /*xGlobal*/ 16) scatterseries0_changes.xValues = /*xGlobal*/ ctx[4];
    			if (dirty & /*yGlobal*/ 8) scatterseries0_changes.yValues = /*yGlobal*/ ctx[3];
    			scatterseries0.$set(scatterseries0_changes);
    			const scatterseries1_changes = {};
    			if (dirty & /*xLocalVal*/ 64) scatterseries1_changes.xValues = /*xLocalVal*/ ctx[6];
    			if (dirty & /*yLocalVal*/ 128) scatterseries1_changes.yValues = /*yLocalVal*/ ctx[7];
    			scatterseries1.$set(scatterseries1_changes);
    			const lineseries1_changes = {};
    			if (dirty & /*lineX*/ 32) lineseries1_changes.xValues = /*lineX*/ ctx[5];
    			if (dirty & /*lineYLocal*/ 512) lineseries1_changes.yValues = /*lineYLocal*/ ctx[9];
    			...
    			if (dirty & /*textLocal*/ 256) textlegend_changes.elements = /*textLocal*/ ctx[8];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(73:3) {#if localModel !== undefined && indSeg >= 0}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(89:3) {#if statCV !== undefined}",
    		ctx
    	});
    ...
    // (67:0) <Axes limX={mrange(xGlobal)} limY={mrange(yGlobal)} xLabel="x" yLabel="y">
    function create_default_slot$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*localModel*/ ctx[0] !== undefined && /*indSeg*/ ctx[1] >= 0) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*textGlobal*/ 2048) textlegend_changes.elements = /*textGlobal*/ ctx[11];
    			textlegend.$set(textlegend_changes);
    			let previous_block_index = current_block_type_index;
    			current_block_type_index = select_block_type(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(67:0) <Axes limX={mrange(xGlobal)} limY={mrange(yGlobal)} xLabel=\\\"x\\\" yLabel=\\\"y\\\">",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, xGlobal, yGlobal, textLocal, statCV, lineX, lineYLocal, xLocalVal, yLocalVal, lineYGlobal, localModel, indSeg, textGlobal*/ 528383) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('globalModel' in $$props) $$invalidate(15, globalModel = $$props.globalModel);
    		if ('localModel' in $$props) $$invalidate(0, localModel = $$props.localModel);
    		if ('indSeg' in $$props) $$invalidate(1, indSeg = $$props.indSeg);
    		if ('segments' in $$props) $$invalidate(16, segments = $$props.segments);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('xLocalVal' in $$props) $$invalidate(6, xLocalVal = $$props.xLocalVal);
    		if ('yLocalVal' in $$props) $$invalidate(7, yLocalVal = $$props.yLocalVal);
    		if ('textLocal' in $$props) $$invalidate(8, textLocal = $$props.textLocal);
    		if ('lineYLocal' in $$props) $$invalidate(9, lineYLocal = $$props.lineYLocal);
    		...
    		if ('lineYGlobal' in $$props) $$invalidate(10, lineYGlobal = $$props.lineYGlobal);
    		if ('textGlobal' in $$props) $$invalidate(11, textGlobal = $$props.textGlobal);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*globalModel*/ 32768) {
    		...
    		if ($$self.$$.dirty & /*globalModel*/ 32768) {
    			$$invalidate(11, textGlobal = getModelString(globalModel, "Global model", colorLocalVal + "a0").concat(getStatString(globalModel.stat)));
    		}

    		if ($$self.$$.dirty & /*globalModel, lineX*/ 32800) {
    			$$invalidate(10, lineYGlobal = polypredict(globalModel, lineX));
    		}

    		if ($$self.$$.dirty & /*localModel, indSeg, statCV, lineX, xGlobal, segments, yGlobal*/ 65599) {
    			// points and statistics for current local model
    			if (localModel !== undefined) {
    				xLocal = localModel.data.X[0];
    				yLocal = localModel.data.y;

    				$$invalidate(8, textLocal = indSeg >= 0
    				...
    				$$invalidate(9, lineYLocal = polypredict(localModel, lineX));
    				$$invalidate(6, xLocalVal = subset(xGlobal, segments.val[indSeg]));
    				$$invalidate(7, yLocalVal = subset(yGlobal, segments.val[indSeg]));
    			}
    		}
    	};
    ...
    class AppPlot extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*globalModel*/ ctx[15] === undefined && !('globalModel' in props)) {
    		...
    		if (/*segments*/ ctx[16] === undefined && !('segments' in props)) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	let appcontrolswitch1_props = {
    		...
    		id: "pDegree",
    		label: "Polynomial",
    		options: Object.keys(/*pDegrees*/ ctx[8])
    	};

    	if (/*pName*/ ctx[1] !== void 0) {
    		appcontrolswitch1_props.value = /*pName*/ ctx[1];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*indSeg*/ 8) appcontrolswitch0_changes.disable = /*indSeg*/ ctx[3] > -1;
    			...
    			if (dirty & /*indSeg*/ 8) appcontrolswitch1_changes.disable = /*indSeg*/ ctx[3] > -1;

    			if (!updating_value_1 && dirty & /*pName*/ 2) {
    				updating_value_1 = true;
    				appcontrolswitch1_changes.value = /*pName*/ ctx[1];
    				add_flush_callback(() => updating_value_1 = false);
    			}

    			appcontrolswitch1.$set(appcontrolswitch1_changes);
    			const appcontrolbutton_changes = {};
    			if (dirty & /*indSeg*/ 8) appcontrolbutton_changes.disable = /*indSeg*/ ctx[3] > -1;
    			appcontrolbutton.$set(appcontrolbutton_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, indSeg, pName, cvType*/ 1048587) {
    ...
    function create_help_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 154, 6, 4936);
    			add_location(em0, file, 157, 173, 5517);
    			add_location(sub, file, 157, 183, 5527);
    			add_location(p0, file, 155, 6, 4968);
    			add_location(em1, file, 161, 261, 5932);
    			add_location(em2, file, 161, 287, 5958);
    			add_location(em3, file, 161, 417, 6088);
    			add_location(em4, file, 161, 513, 6184);
    			add_location(p1, file, 159, 6, 5560);
    			add_location(p2, file, 163, 6, 6228);
    			attr_dev(div, "slot", "help");
    			add_location(div, file, 153, 3, 4912);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, indSeg, pName, cvType, segments, yCV, statCV, localModel, globalModel*/ 1048831) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('pName' in $$props) $$invalidate(1, pName = $$props.pName);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*pName*/ 2) {
    			$$invalidate(12, pDegree = pDegrees[pName]);
    		}
