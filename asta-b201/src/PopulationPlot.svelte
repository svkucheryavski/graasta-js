...
<Axes title="Population (N = 400)" limX={mrange(pop[0], 0.1)} limY={mrange(pop[1], 0.05)} >
   <!-- population points  -->
   <ScatterSeries xValues={pop1X} yValues={pop1Y} borderWidth={2} markerSize={2} borderColor={colors[0] + "50"} faceColor={colors[0] + "50"}/>
   <ScatterSeries xValues={pop2X} yValues={pop2Y} borderWidth={2} markerSize={2} borderColor={colors[1] + "50"} faceColor={colors[1] + "50"}/>
   <!-- sample points on top  -->
   <ScatterSeries xValues={samp1X} yValues={samp1Y} borderWidth={4} markerSize={2.15} borderColor={colors[0]} faceColor={"white"}/>
   <ScatterSeries xValues={samp2X} yValues={samp2Y} borderWidth={4} markerSize={2.15} borderColor={colors[1]} faceColor={"white"}/>
</Axes>
