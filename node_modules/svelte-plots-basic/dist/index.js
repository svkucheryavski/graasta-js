(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.PlotsBasic = {}));
    ...
    function create_fragment$b(ctx) {
    	...
    	const xaxis_slot_template = /*#slots*/ ctx[25].xaxis;
    	const xaxis_slot = create_slot(xaxis_slot_template, ctx, /*$$scope*/ ctx[24], get_xaxis_slot_context);
    	const yaxis_slot_template = /*#slots*/ ctx[25].yaxis;
    	const yaxis_slot = create_slot(yaxis_slot_template, ctx, /*$$scope*/ ctx[24], get_yaxis_slot_context);
    	const default_slot_template = /*#slots*/ ctx[25].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[24], null);
    	const box_slot_template = /*#slots*/ ctx[25].box;
    	const box_slot = create_slot(box_slot_template, ctx, /*$$scope*/ ctx[24], get_box_slot_context);
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (xaxis_slot) {
    				if (xaxis_slot.p && (!current || dirty[0] & /*$$scope*/ 16777216)) {
    					update_slot_base(
    						xaxis_slot,
    						xaxis_slot_template,
    						ctx,
    						...
    						: get_slot_changes(xaxis_slot_template, /*$$scope*/ ctx[24], dirty, get_xaxis_slot_changes),
    			...
    			if (yaxis_slot) {
    				if (yaxis_slot.p && (!current || dirty[0] & /*$$scope*/ 16777216)) {
    					update_slot_base(
    						yaxis_slot,
    						yaxis_slot_template,
    						ctx,
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[24])
    						: get_slot_changes(yaxis_slot_template, /*$$scope*/ ctx[24], dirty, get_yaxis_slot_changes),
    			...
    			if (box_slot) {
    				if (box_slot.p && (!current || dirty[0] & /*$$scope*/ 16777216)) {
    					update_slot_base(
    						box_slot,
    						box_slot_template,
    						ctx,
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[24])
    						: get_slot_changes(box_slot_template, /*$$scope*/ ctx[24], dirty, get_box_slot_changes),
     ...
     */
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*axesMargins, $scale*/ 262160) {
    			...
    			$$invalidate(19, margins = axesMargins.map(v => v * AXES_MARGIN_FACTORS[$scale]));
    		}

    		if ($$self.$$.dirty[0] & /*$yLim, $xLim, $width, margins, $height*/ 16252928) {
    ...
    function create_each_block$3(ctx) {
    	...
    	return {
    		c() {
    			rect = svg_element("rect");
    			attr(rect, "x", rect_x_value = /*rx*/ ctx[4][/*i*/ ctx[25]]);
    			attr(rect, "y", rect_y_value = /*ry*/ ctx[3][/*i*/ ctx[25]]);
    			attr(rect, "width", rect_width_value = /*rw*/ ctx[2][/*i*/ ctx[25]]);
    			attr(rect, "height", rect_height_value = /*rh*/ ctx[1][/*i*/ ctx[25]]);
    			attr(rect, "style", /*barsStyleStr*/ ctx[5]);
    		},
    		m(target, anchor) {
    			insert(target, rect, anchor);
    		},
    		p(ctx, dirty) {
    			if (dirty & /*rx*/ 16 && rect_x_value !== (rect_x_value = /*rx*/ ctx[4][/*i*/ ctx[25]])) {
    				attr(rect, "x", rect_x_value);
    			}

    			if (dirty & /*ry*/ 8 && rect_y_value !== (rect_y_value = /*ry*/ ctx[3][/*i*/ ctx[25]])) {
    				attr(rect, "y", rect_y_value);
    			}

    			if (dirty & /*rw*/ 4 && rect_width_value !== (rect_width_value = /*rw*/ ctx[2][/*i*/ ctx[25]])) {
    				attr(rect, "width", rect_width_value);
    			}

    			if (dirty & /*rh*/ 2 && rect_height_value !== (rect_height_value = /*rh*/ ctx[1][/*i*/ ctx[25]])) {
    				attr(rect, "height", rect_height_value);
    			}
    		},
    		d(detaching) {
    ...
    function create_fragment$8(ctx) {
    	let if_block_anchor;
    	let if_block = /*rx*/ ctx[4] !== undefined && /*ry*/ ctx[3] !== undefined && create_if_block$6(ctx);
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (/*rx*/ ctx[4] !== undefined && /*ry*/ ctx[3] !== undefined) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, axesWidth, value => $$invalidate(19, $axesWidth = value));
    	const axesHeight = axes.height;
    	component_subscribe($$self, axesHeight, value => $$invalidate(17, $axesHeight = value));
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*left, $xLim, $axesWidth*/ 1572865) {
    			// reactive variables for coordinates of data points in pixels
    			$$invalidate(4, rx = axes.scaleX(left, $xLim, $axesWidth));
    		}

    		if ($$self.$$.dirty & /*top, $yLim, $axesHeight*/ 397312) {
    			$$invalidate(3, ry = axes.scaleY(top, $yLim, $axesHeight));
    		}

    		if ($$self.$$.dirty & /*width, $xLim, $axesWidth*/ 1573888) {
    			$$invalidate(2, rw = axes.scaleX(width, $xLim, $axesWidth, true));
    		}

    		if ($$self.$$.dirty & /*height, $yLim, $axesHeight*/ 395264) {
    			$$invalidate(1, rh = axes.scaleY(height, $yLim, $axesHeight, true));
    		}
    	};
    ...
    function create_each_block$1(ctx) {
    	...
    	return {
    		c() {
    			text_1 = svg_element("text");
    			attr(text_1, "style", /*textStyleStr*/ ctx[2]);
    			attr(text_1, "x", text_1_x_value = /*x*/ ctx[6][/*i*/ ctx[27]]);
    			attr(text_1, "y", text_1_y_value = /*y*/ ctx[5][/*i*/ ctx[27]]);
    			attr(text_1, "dx", /*dx*/ ctx[4]);
    			attr(text_1, "dy", /*dy*/ ctx[3]);
    			attr(text_1, "dominant-baseline", "middle");
    			attr(text_1, "text-anchor", text_1_text_anchor_value = /*textAnchors*/ ctx[7][/*pos*/ ctx[1]]);
    		},
    		m(target, anchor) {
    			insert(target, text_1, anchor);
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*textStyleStr*/ 4) {
    				attr(text_1, "style", /*textStyleStr*/ ctx[2]);
    			}

    			if (dirty & /*x*/ 64 && text_1_x_value !== (text_1_x_value = /*x*/ ctx[6][/*i*/ ctx[27]])) {
    				attr(text_1, "x", text_1_x_value);
    			}

    			if (dirty & /*y*/ 32 && text_1_y_value !== (text_1_y_value = /*y*/ ctx[5][/*i*/ ctx[27]])) {
    				attr(text_1, "y", text_1_y_value);
    			}
    ...
    function create_fragment$5(ctx) {
    	let if_block_anchor;
    	let if_block = /*x*/ ctx[6] !== undefined && /*y*/ ctx[5] !== undefined && create_if_block$3(ctx);
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (/*x*/ ctx[6] !== undefined && /*y*/ ctx[5] !== undefined) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*xValues, $xLim, $axesWidth*/ 12591104) {
    			// reactive variables for coordinates of data points in pixels
    			$$invalidate(6, x = axes.scaleX(xValues, $xLim, $axesWidth));
    		}

    		if ($$self.$$.dirty & /*yValues, $yLim, $axesHeight*/ 3162112) {
    			$$invalidate(5, y = axes.scaleY(yValues, $yLim, $axesHeight));
    		}

    		if ($$self.$$.dirty & /*pos, $scale*/ 524290) {
    			$$invalidate(4, dx = [0, 0, 1, 0, -1][pos] * axes.LABELS_MARGIN[$scale]);
    		}

    		if ($$self.$$.dirty & /*pos, $scale*/ 524290) {
    			$$invalidate(3, dy = [0, 1, 0, -1, 0][pos] * axes.LABELS_MARGIN[$scale]);
    		}

    		if ($$self.$$.dirty & /*faceColor, borderWidth, borderColor, textSize*/ 491520) {
    			// styles for bars and labels
    			$$invalidate(2, textStyleStr = `fill:${faceColor};stroke-width:${borderWidth}px;stroke:${borderColor};font-size:${textSize}em;`);
    		}
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			g = svg_element("g");
    			create_component(rectangles.$$.fragment);
    			attr(g, "class", "series series_bar");
    ...
    function add_css(target) {
    	append_styles(target, "svelte-11a4d2d", ".marker{font-size:1em;cursor:default}.marker:hover{opacity:90%}.series_scatter > *:hover + .labels_hover{visibility:visible;opacity:1}");
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(g, "class", "series series_scatter");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*lineColor, lineWidth, $scale, lineType*/ 39936) {
    			$$invalidate(1, lineStyleStr = `fill:transparent;stroke:${lineColor};stroke-width: ${lineWidth}px;stroke-dasharray:${axes.LINE_STYLES[$scale][lineType - 1]}`);
    		}
    	};
